...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.60\textwidth]{Figures/Fig12a_LHC_Y2SByY1S_NTrk.pdf}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=0.60\textwidth]{Figures/Fig12b_LHC_Y2SByY1S_NTrk.pdf}
\caption{(Color online)
 The ratio $\Upsilon$(2S)/$\Upsilon$(1S) as a function of event activity measured in 
...
The  Figure~\ref{fig:UpsilonpPb} shows the ratio of $\Upsilon$(2S)
