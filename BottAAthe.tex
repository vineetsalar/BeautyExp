...
It was predicted that if QGP is formed in heavy ion collisions, quarkonia
would be suppressed in A+A collisions~\cite{Matsui:1986dk} as the force between the quarks
will be colour screened in QGP phase.
...
enriched, in the high energy scenario (like LHC), by recombination mechanism. At very 
high energies abundant production of $Q$ and $\bar Q$ may lead to new quarkonia production 
in the medium although it is more effective for charmonia state. 
Recombination contribution on the bottommonia states is expected to be much smaller
since the bottom quark mass ($\sim$ 4.5 GeV) is three times more than the charm quark
its thermalization at temperatures $\sim$ 0.6 GeV will be negligible. 
