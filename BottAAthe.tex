...
will be colour screened and the quakonium can not bind in QGP phase.
...
$(r_Q)$ is  much greater than the screening radius radius then one heavy 
...
as nPDF. The nPDF to PDF ratio throws light on the modification due to the modification of PDFs.
This quantity is denoted as $R_i(x,Q^2)=f_i^{p \epsilon A} (x, Q^2) /f_i^p  (x, Q^2)$.
...
inelastic cross-section of the quarkonia with 
the nucleon. 
