\section{Bottomonia production mechanism in heavy ion collisions: Theory overview}
...
In a series of papers~\cite{Strickland:2011aa,strickland_universe,stricland_2018} people have studied bottomonia suppression using anisotropic hydrodynamics. 
...
\end{equation}
%
where $\hat{r}=m_D r$ and $\phi$, $\psi_1$, and $\psi_2$ are defined in Ref.~\cite{stricland_universe}. 
