...
cross sections have been measured in the range 0$\textless p_{T} \textless$16 GeV/c
for $\Upsilon$(1S) and in the range
0$\textless p_{T}\textless$10 GeV/c for $\Upsilon$(2S) and $\Upsilon$(3S).
...
$p_{T}<$ 100 GeV/c at LHC by ALICE~\cite{ATLAS:2011nal,ATLAS:2012lmu},
...
CMS measured the $\Upsilon$(nS) polarization in 2003 pp collisions
...
Analysis of new LHC data will extend the reach of the kinematics to test the NRQCD
...
partons. $\mu_F$ and $\mu_R$ are the respectively, fragmentation and renormalization scales. 
...
We show reproduce here some of the representative calculations using ICEM.
...
the incident protons as a function of $x_1$($x2$); the fractions of the total momentum
